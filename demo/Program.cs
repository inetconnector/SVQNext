...
ImageFastOps.MapRows(img, px => new Rgba32(px.R, px.G, (byte)(255 - px.B), 255));
ImageSharpCompat.SaveBitmap(img, Path.Combine("out", "demo.png"));
...
// FEC encode+recover
var fec = FecPipelineHook.EncodeWithFec(payload);
...
var a = Bytes(1 << 16, 1);
var b = Bytes(1 << 16, 2);
var sad = CodecCoreOptimized.SumAbsDiff(a, b);
